...
<aside class="sidebar">
  ...
  <nav>
    <div class="menu-section">
      ...
      <a href="verifikasiprestasi.html" class="nav-item" data-page="verifikasiprestasi">
...
function ensureSidebarStyles() {
  if (document.getElementById("staff-sidebar-styles")) return;
  const styleEl = document.createElement("style");
  styleEl.id = "staff-sidebar-styles";
...
export function initStaffSidebar(targetElement) {
  const target =
